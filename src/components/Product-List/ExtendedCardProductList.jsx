...
export default function ExtendedCardProductList() {
  return (
    <div className="flex flex-col absolute p-8 rounded-lg top-40 bg-slate-100 snap-y">
      <div className="space-y-5">
        ...
        <div className="flex flex-row justify-between items-center bg-slate-300 p-3 rounded">
          <div className="font-semibold">Choose Category</div>
          <MdExpandMore className="w-9 h-9" />
        </div>
